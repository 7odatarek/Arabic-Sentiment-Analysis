...
def preprocessing(train_data):
    train_data['review_description'] = train_data['review_description'].apply(preprocess)
    train_data['review_description'] = train_data['review_description'].apply(word_tokenize)
...
RNN(train_data)
# X_train, X_val, y_train, y_val,X_test = preprocessing(train_data,test_data)
